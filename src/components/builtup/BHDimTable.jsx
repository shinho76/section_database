...
/** Compact dimension-entry table: row 1 = field names (height/width/
 * thickness…), row 2 = inch inputs, row 3 = mm inputs — editing either unit
 * row updates the other live. Thickness fields (`thickness: true`) get a
