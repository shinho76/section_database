    ...
    <>
      ...
      <div className="bh-grid">
        <div className="panel">
          ...
          <PlateThicknessInput label="tf-top (상부 플랜지 두께)" mm={mm.tfTop} onChangeMm={set('tfTop')} />
          <div className="field-row">
            <DualUnitInput label="bf-bot (하부 플랜지 폭)" mm={mm.bfBot} onChangeMm={set('bfBot')} />
          </div>
          <PlateThicknessInput label="tf-bot (하부 플랜지 두께)" mm={mm.tfBot} onChangeMm={set('tfBot')} />
