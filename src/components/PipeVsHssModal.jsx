    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal-panel" onClick={(e) => e.stopPropagation()} style={{ maxWidth: 640 }}>
        ...
        <div className="modal-body">
          ...
          <p className="note">
            한국에도 이 두 용도가 규격으로 나뉘어 있습니다 — 배관 겸용인 Pipe(A53)에 대응하는 것은 사이드바의 <b>KS PP</b>(KS D 3507,
            배관용 탄소강관 SPP, 2025-08-29 최신 개정 확인·현재 유효), 구조 전용인 HSS-Round에 대응하는 것은 <b>KS P</b>(KS D 3566,
            일반구조용 탄소강관)입니다. 이름은 비슷하지만 서로 다른 KS 규격이니 혼동하지 마세요.
          </p>
        </div>
